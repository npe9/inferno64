...
align(long i, Type *t, int op)
{
	...
	case Aarg2:	/* width of a parameter */
		/*
		 * LP64: pad each stack arg to SZ_VLONG (8), matching
		 * Inferno/riscv64 va_arg and utils/6c.  SZ_LONG (4) packed
		 * ints so multi-arg snprint/print read the wrong slots.
		 */
		o += t->width;
		w = SZ_VLONG;
		break;
