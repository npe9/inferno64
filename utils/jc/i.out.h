 ...
 *
 * Fields are 32-bit (Plan 9 long).  On LP64 hosts sizeof(long)==8, so
 * using long here made Ieee 16 bytes; jl datblk then copied only the
 * first 8 bytes (the low word / zero pad) and float literals linked as 0.
 */
