	...
	/*
	 * LLP64 (like amd64): void* at 0, int c at 8 (8-byte slot),
	 * ulong n at 16.  Load n with MOVWU — a 64-bit MOV picks up
	 * stack garbage in the high half and memset runs to 0x88000000.
	 */
	MOVWU	n+16(FP), R10		/* R10 is count */
