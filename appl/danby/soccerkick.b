...
new(): ref Model
{
	...
	return ref Model(array[] of {28.0,0.28,0.0,0.006,0.018,9.81});
}

title(): string
{
	return "Kicking a ball in soccer";
}

parameterlabels(): array of string
{
	return array[] of {"speed", "elevation", "aim", "drag", "curve", "gravity"};
}

parameterminima(): array of real
{
	return array[] of {0.0,0.0,-0.5,0.0,-0.08,0.0};
}

parameterranges(): array of real
{
	return array[] of {45.0,0.9,0.5,0.03,0.08,20.0};
}
