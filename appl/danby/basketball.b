...
new(): ref Model
{
	...
	return ref Model(array[] of {8.5,0.85,0.001,0.00015,20.0,9.81});
}

title(): string
{
	return "Shooting in basketball";
}

parameterlabels(): array of string
{
	return array[] of {"speed", "angle", "drag", "lift", "backspin", "gravity"};
}

parameterranges(): array of real
{
	return array[] of {16.0,1.45,0.02,0.003,100.0,20.0};
}
