...
new(): ref Model
{
	...
	return ref Model(array[] of {1.0,0.055,0.026,1.0,0.08});
}

title(): string
{
	return "The rotation of the Moon";
}
...
{
	return array[] of {3.0,0.8,0.5,4.0,1.0};
}

initialstate(model: ref Model): array of real
{
	return array[] of {0.0,0.15,model.parameter[3]*model.parameter[0]};
}
...
{
	return array[] of {"libration", "spin/orbit"};
}
