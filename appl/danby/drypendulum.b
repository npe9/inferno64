...
new(): ref Model
{
	...
	return ref Model(array[] of {1.0,1.2,0.0,9.81,0.35,1.0});
}

title(): string
{
	return "The pendulum with dry friction";
}

parameterlabels(): array of string
{
	return array[] of {"length", "initial angle", "initial speed", "gravity", "dry friction", "mass"};
}
