...
init(nil: ref Draw->Context, nil: list of string)
{
	...
	periodicvolterra = load Twospecies "/dis/danby/plugin/periodicvolterra.dis";
	predatorfishing = load Twospecies "/dis/danby/plugin/predatorfishing.dis";
	logisticprey = load Twospecies "/dis/danby/plugin/logisticprey.dis";
	logisticpredators = load Twospecies "/dis/danby/plugin/logisticpredators.dis";
	alternativepredation = load Twospecies "/dis/danby/plugin/alternativepredation.dis";
	maypredator = load Twospecies "/dis/danby/plugin/maypredator.dis";
	internalcompetition = load Twospecies "/dis/danby/plugin/internalcompetition.dis";
	cooperation = load Twospecies "/dis/danby/plugin/cooperation.dis";
	competition = load Twospecies "/dis/danby/plugin/competition.dis";
	ecologymodel = load Twospecies "/dis/danby/plugin/ecology.dis";
	childcare = load Populationmodel "/dis/danby/plugin/childcare.dis";
	manyspecies = load Populationmodel "/dis/danby/plugin/manyspecies.dis";
	foodchainmodel = load Populationmodel "/dis/danby/plugin/foodchain.dis";
	violetsantsrodents = load Populationmodel "/dis/danby/plugin/violetsantsrodents.dis";
	parasite = load Populationmodel "/dis/danby/plugin/parasite.dis";
	cannibalism = load Populationmodel "/dis/danby/plugin/cannibalism.dis";
	changingenvironment = load Populationmodel "/dis/danby/plugin/changingenvironment.dis";
	lakepollution = load Populationmodel "/dis/danby/plugin/lakepollution.dis";
	budworm = load Populationmodel "/dis/danby/plugin/budworm.dis";
	heliumburning = load Populationmodel "/dis/danby/plugin/heliumburning.dis";
	decomposition = load Populationmodel "/dis/danby/plugin/decomposition.dis";
	enzymekinetics = load Populationmodel "/dis/danby/plugin/enzymekinetics.dis";
	enzymeapplication = load Populationmodel "/dis/danby/plugin/enzymeapplication.dis";
	moreenzyme = load Populationmodel "/dis/danby/plugin/moreenzyme.dis";
	stillmoreenzyme = load Populationmodel "/dis/danby/plugin/stillmoreenzyme.dis";
	brusselator = load Populationmodel "/dis/danby/plugin/brusselator.dis";
	oregonator = load Populationmodel "/dis/danby/plugin/oregonator.dis";
	reactorstability = load Populationmodel "/dis/danby/plugin/reactorstability.dis";
	tankcontrol = load Populationmodel "/dis/danby/plugin/tankcontrol.dis";
	reservoir = load Populationmodel "/dis/danby/plugin/reservoir.dis";
	epidemicmodel = load Populationmodel "/dis/danby/plugin/epidemic.dis";
	vaccinationmodel = load Populationmodel "/dis/danby/plugin/vaccination.dis";
	migrationmodel = load Populationmodel "/dis/danby/plugin/migration.dis";
	diseasebirthdeath1 = load Populationmodel "/dis/danby/plugin/diseasebirthdeath1.dis";
	diseasebirthdeath2 = load Populationmodel "/dis/danby/plugin/diseasebirthdeath2.dis";
	crossinfection = load Populationmodel "/dis/danby/plugin/crossinfection.dis";
	incubation = load Populationmodel "/dis/danby/plugin/incubation.dis";
	seasonaldisease = load Populationmodel "/dis/danby/plugin/seasonaldisease.dis";
	malaria = load Populationmodel "/dis/danby/plugin/malaria.dis";
	gonorrhea = load Populationmodel "/dis/danby/plugin/gonorrhea.dis";
	hiv = load Populationmodel "/dis/danby/plugin/hiv.dis";
	weightchange = load Populationmodel "/dis/danby/plugin/weightchange.dis";
	heartbeat = load Populationmodel "/dis/danby/plugin/heartbeat.dis";
	lanchester = load Populationmodel "/dis/danby/plugin/lanchester.dis";
	fishingone = load Populationmodel "/dis/danby/plugin/fishingone.dis";
	productionexchange = load Populationmodel "/dis/danby/plugin/productionexchange.dis";
	fishingtwo = load Populationmodel "/dis/danby/plugin/fishingtwo.dis";
	boommodel = load Populationmodel "/dis/danby/plugin/boom.dis";
	twocapital = load Populationmodel "/dis/danby/plugin/twocapital.dis";
	spinningball = load Trajectory "/dis/danby/plugin/spinningball.dis";
	baseballpitch = load Trajectory "/dis/danby/plugin/baseballpitch.dis";
	knuckleball = load Trajectory "/dis/danby/plugin/knuckleball.dis";
	flyball = load Trajectory "/dis/danby/plugin/flyball.dis";
	softballpitch = load Trajectory "/dis/danby/plugin/softballpitch.dis";
	golfdrive = load Trajectory "/dis/danby/plugin/golfdrive.dis";
	badminton = load Trajectory "/dis/danby/plugin/badminton.dis";
	tabletennis = load Trajectory "/dis/danby/plugin/tabletennis.dis";
	basketball = load Trajectory "/dis/danby/plugin/basketball.dis";
	discus = load Trajectory "/dis/danby/plugin/discus.dis";
	javelin = load Trajectory "/dis/danby/plugin/javelin.dis";
	skijump = load Trajectory "/dis/danby/plugin/skijump.dis";
	skylab = load Trajectory "/dis/danby/plugin/skylab.dis";
	icbmrange = load Trajectory "/dis/danby/plugin/icbmrange.dis";
	rocket2d = load Trajectory "/dis/danby/plugin/rocket2d.dis";
	reentry = load Trajectory "/dis/danby/plugin/reentry.dis";
	soccerkick = load Flight3d "/dis/danby/plugin/soccerkick.dis";
	cricketbowl = load Flight3d "/dis/danby/plugin/cricketbowl.dis";
	cricketswing = load Flight3d "/dis/danby/plugin/cricketswing.dis";
	badfootball = load Flight3d "/dis/danby/plugin/badfootball.dis";
	icbmaccuracy = load Flight3d "/dis/danby/plugin/icbmaccuracy.dis";
	running = load Mechanism "/dis/danby/plugin/running.dis";
	diving = load Mechanism "/dis/danby/plugin/diving.dis";
	polevault = load Mechanism "/dis/danby/plugin/polevault.dis";
	flightmodel = load Mechanism "/dis/danby/plugin/flight.dis";
	hovercraft = load Mechanism "/dis/danby/plugin/hovercraft.dis";
	shipmotion = load Mechanism "/dis/danby/plugin/shipmotion.dis";
	balloon = load Mechanism "/dis/danby/plugin/balloon.dis";
	joggingcompanion = load Mechanism "/dis/danby/plugin/joggingcompanion.dis";
	bungee = load Mechanism "/dis/danby/plugin/bungee.dis";
	yoyo = load Mechanism "/dis/danby/plugin/yoyo.dis";
	amusementchaos = load Mechanism "/dis/danby/plugin/amusementchaos.dis";
	spacestationball = load Mechanism "/dis/danby/plugin/spacestationball.dis";
	fireworks = load Mechanism "/dis/danby/plugin/fireworks.dis";
	rocketintro = load Mechanism "/dis/danby/plugin/rocketintro.dis";
	multistagerocket = load Mechanism "/dis/danby/plugin/multistagerocket.dis";
	spaceyoyo = load Mechanism "/dis/danby/plugin/spaceyoyo.dis";
	stretchyoyo = load Mechanism "/dis/danby/plugin/stretchyoyo.dis";
	venushead = load Mechanism "/dis/danby/plugin/venushead.dis";
	simplependulum = load Mechanism "/dis/danby/plugin/simplependulum.dis";
	pendulumperiod = load Mechanism "/dis/danby/plugin/pendulumperiod.dis";
	dampedpendulum = load Mechanism "/dis/danby/plugin/dampedpendulum.dis";
	drypendulum = load Mechanism "/dis/danby/plugin/drypendulum.dis";
	clockpendulum = load Mechanism "/dis/danby/plugin/clockpendulum.dis";
	windpendulum = load Mechanism "/dis/danby/plugin/windpendulum.dis";
	loadedpendulum = load Mechanism "/dis/danby/plugin/loadedpendulum.dis";
	synchronousmotor = load Mechanism "/dis/danby/plugin/synchronousmotor.dis";
	gravitypendulum = load Mechanism "/dis/danby/plugin/gravitypendulum.dis";
	magneticpendulum2d = load Mechanism "/dis/danby/plugin/magneticpendulum2d.dis";
	swing1 = load Mechanism "/dis/danby/plugin/swing1.dis";
	swing2 = load Mechanism "/dis/danby/plugin/swing2.dis";
	varyingpendulum = load Mechanism "/dis/danby/plugin/varyingpendulum.dis";
	swingingcenser = load Mechanism "/dis/danby/plugin/swingingcenser.dis";
	movingpivot = load Mechanism "/dis/danby/plugin/movingpivot.dis";
	pegpendulum = load Mechanism "/dis/danby/plugin/pegpendulum.dis";
	slidingpendulum1 = load Mechanism "/dis/danby/plugin/slidingpendulum1.dis";
	slidingpendulum2 = load Mechanism "/dis/danby/plugin/slidingpendulum2.dis";
	atwoodpendulum = load Mechanism "/dis/danby/plugin/atwoodpendulum.dis";
	tablependulum = load Mechanism "/dis/danby/plugin/tablependulum.dis";
	doublependulummodel = load Mechanism "/dis/danby/plugin/doublependulum.dis";
	wheelpendulum = load Mechanism "/dis/danby/plugin/wheelpendulum.dis";
	magneticpendulum3d = load Mechanism "/dis/danby/plugin/magneticpendulum3d.dis";
	dumbbellsatellite = load Mechanism "/dis/danby/plugin/dumbbellsatellite.dis";
	moonrotation = load Mechanism "/dis/danby/plugin/moonrotation.dis";
	hyperionrotation = load Mechanism "/dis/danby/plugin/hyperionrotation.dis";
	mercuryrotation = load Mechanism "/dis/danby/plugin/mercuryrotation.dis";
	tidalrotation = load Mechanism "/dis/danby/plugin/tidalrotation.dis";
	nonlinearsprings = load Mechanism "/dis/danby/plugin/nonlinearsprings.dis";
	duffing = load Mechanism "/dis/danby/plugin/duffing.dis";
	vanderpol = load Mechanism "/dis/danby/plugin/vanderpol.dis";
	variationparameters = load Mechanism "/dis/danby/plugin/variationparameters.dis";
	columnbuckling = load Mechanism "/dis/danby/plugin/columnbuckling.dis";
	catastrophemachine = load Mechanism "/dis/danby/plugin/catastrophemachine.dis";
	attractingwires = load Mechanism "/dis/danby/plugin/attractingwires.dis";
	violinbow = load Mechanism "/dis/danby/plugin/violinbow.dis";
	carrierlanding = load Mechanism "/dis/danby/plugin/carrierlanding.dis";
	springpivot = load Mechanism "/dis/danby/plugin/springpivot.dis";
	springpendulum = load Mechanism "/dis/danby/plugin/springpendulum.dis";
	chaoticwheel = load Mechanism "/dis/danby/plugin/chaoticwheel.dis";
	fireflies = load Mechanism "/dis/danby/plugin/fireflies.dis";
	pursuit = load Mechanism "/dis/danby/plugin/pursuit.dis";
	lowbombing = load Mechanism "/dis/danby/plugin/lowbombing.dis";
	carbonmicrophone = load Mechanism "/dis/danby/plugin/carbonmicrophone.dis";
	rotatingring1 = load Mechanism "/dis/danby/plugin/rotatingring1.dis";
	rotatingring2 = load Mechanism "/dis/danby/plugin/rotatingring2.dis";
	compass = load Mechanism "/dis/danby/plugin/compass.dis";
	pistonflywheel = load Mechanism "/dis/danby/plugin/pistonflywheel.dis";
	wattgovernor = load Mechanism "/dis/danby/plugin/wattgovernor.dis";
	dynamoreversal = load Mechanism "/dis/danby/plugin/dynamoreversal.dis";
	twomagnet = load Mechanism "/dis/danby/plugin/twomagnet.dis";
	bernoulli = load Mechanism "/dis/danby/plugin/bernoulli.dis";
	threebody = load Orbital "/dis/danby/plugin/threebody.dis";
	moontrip = load Orbital "/dis/danby/plugin/moontrip.dis";
	lagrange1 = load Orbital "/dis/danby/plugin/lagrange1.dis";
	lagrange2 = load Orbital "/dis/danby/plugin/lagrange2.dis";
	aerobraking = load Orbital "/dis/danby/plugin/aerobraking.dis";
	lowthrust = load Orbital "/dis/danby/plugin/lowthrust.dis";
	cometcatch = load Orbital "/dis/danby/plugin/cometcatch.dis";
	jupiterboost = load Orbital "/dis/danby/plugin/jupiterboost.dis";
	grandtour = load Orbital "/dis/danby/plugin/grandtour.dis";
	perihelion = load Orbital "/dis/danby/plugin/perihelion.dis";
	poyntingrobertson = load Orbital "/dis/danby/plugin/poyntingrobertson.dis";
	galaxies = load Orbital "/dis/danby/plugin/galaxies.dis";
	starmodel = load Profile "/dis/danby/plugin/starmodel.dis";
	whitedwarf = load Profile "/dis/danby/plugin/whitedwarf.dis";
